...
class SystemApi {
  ...
  /// * [oldPassword]
  /// * [newPassword]
  /// * [type] -  ℹ️ Used in **RaspiBlitz only**. Password A, B or C. Must be one of `[\"a\", \"b\", \"c\"]`
  ...
  Future<Response<JsonObject>> systemChangePasswordSystemChangePasswordPost({
    ...
    final _queryParameters = <String, dynamic>{
      r'old_password': encodeQueryParameter(
          _serializers, oldPassword, const FullType(String)),
      r'new_password': encodeQueryParameter(
          _serializers, newPassword, const FullType(String)),
      if (type != null)
        r'type':
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RawDebugLogData>>
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> systemRebootSystemRebootPost({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> systemShutdownSystemShutdownPost({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
