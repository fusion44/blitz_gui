...
class BitcoinCoreApi {
  ...
  Future<Response<JsonObject>> bitcoinBlockSubBitcoinBlockSubGet({
    ...
    final _queryParameters = <String, dynamic>{
      if (verbosity != null)
        r'verbosity':
            encodeQueryParameter(_serializers, verbosity, const FullType(int)),
    };
  ...
  Future<Response<int>> bitcoinEstimateFeeBitcoinEstimateFeeGet({
    ...
    final _queryParameters = <String, dynamic>{
      if (targetConf != null)
        r'target_conf':
            encodeQueryParameter(_serializers, targetConf, const FullType(int)),
      if (mode != null)
        r'mode': encodeQueryParameter(
            _serializers, mode, const FullType(FeeEstimationMode)),
    };
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BlockchainInfo>>
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RawTransaction] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RawTransaction>>
    ...
    final _path = r'/bitcoin/get-raw-transaction';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'txid': encodeQueryParameter(_serializers, txid, const FullType(String)),
    };
    ...
    RawTransaction _responseData;

    try {
      const _responseType = FullType(RawTransaction);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as RawTransaction;
