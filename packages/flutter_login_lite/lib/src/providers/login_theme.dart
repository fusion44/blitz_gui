...
class LoginTheme with ChangeNotifier {
  ...
  LoginTheme copyWith({
    ...
    primaryColorAsInputLabel,
      ...
      LoginTheme(
        pageColorLight: pageColorLight ?? this.pageColorLight,
        pageColorDark: pageColorDark ?? this.pageColorDark,
        ...
        beforeHeroFontSize: beforeHeroFontSize ?? this.beforeHeroFontSize,
        afterHeroFontSize: afterHeroFontSize ?? this.afterHeroFontSize,
        footerBackgroundColor:
            footerBackgroundColor ?? this.footerBackgroundColor,
        switchAuthTextColor: switchAuthTextColor ?? this.switchAuthTextColor,
        footerTextStyle: footerTextStyle ?? this.footerTextStyle,
        authButtonPadding: authButtonPadding ?? this.authButtonPadding,
        footerBottomPadding: footerBottomPadding ?? this.footerBottomPadding,
        logoWidth: logoWidth ?? this.logoWidth,
        primaryColorAsInputLabel:
            primaryColorAsInputLabel ?? this.primaryColorAsInputLabel,
      );
}
