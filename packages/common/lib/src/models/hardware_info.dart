...
class HardwareInfo {
  ...
  final List<HardwareNetwork> networks;
  ...
  static HardwareInfo fromJson(Map<String, dynamic> json) {
    ...
    final networks = <HardwareNetwork>[];
    ...
    if (json['networks'] != null) {
      if (json['networks'] is Map) {
        ...
        json['networks'].forEach((v) {
          networks.add(HardwareNetwork.fromJson(v));
        });
      }
    }
...
class HardwareNetwork {
  ...
  static HardwareNetwork fromJson(Map<String, dynamic> json) => HardwareNetwork(
